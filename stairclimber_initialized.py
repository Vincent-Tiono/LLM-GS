...
if __name__ == "__main__":
    ...
    # Read pre-generated programs from file
    program_list = []
    with open(args.search_program_file, 'r') as f:
        content = f.read()
        # Skip the header line
        programs_text = content.split("Program")[1:]
        for program_text in programs_text:
            # Extract the program part (after the number and colon)
            program_str = program_text.split(":", 1)[1].strip()
